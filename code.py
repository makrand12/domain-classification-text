...
print("Logistic Accuracy: ",log_reg)
...
print("Logistic Accuracy 2: ",log_accuracy_2)


y_pred = nb.predict(X_test)
nb_accuracy_2 = accuracy_score(y_test,y_pred)
print("Nb Accuracy 2: ",nb_accuracy_2)


y_pred = lsvm.predict(X_test)
lsvm_accuracy_2 = accuracy_score(y_test,y_pred)
print("LSvm Accuracy 2: ",lsvm_accuracy_2)
